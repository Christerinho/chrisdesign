...
namespace Orchard.jQuery {
    public class ResourceManifest : IResourceManifestProvider {
        public void BuildManifests(ResourceManifestBuilder builder) {
            ...
            manifest.DefineScript("Google_jQuery").SetUrl("//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js", "//ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.js").SetVersion("2.1.1");
            ...
            manifest.DefineScript("jQueryUI").SetUrl("jquery-ui.min.js", "jquery-ui.js").SetVersion("1.9.2").SetDependencies("jQuery")
             ...
             manifest.DefineScript("Google_jQueryUI").SetUrl("//ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.min.js", "//ajax.googleapis.com/ajax/libs/jqueryui/1.11.2/jquery-ui.js")
	        .SetVersion("1.8.11").SetDependencies("Google_jQuery");

            

              manifest.DefineScript("jQueryUICustom").SetUrl("jquery-ui.custom.js", "jquery-ui.custom.js")
	        .SetVersion("1.0.0").SetDependencies("Google_jQuery");
            ...
            // jQuery TreeView
            manifest.DefineScript("jQueryMootoolsCore").SetUrl("mootools-1.2.4-core.js", "mootools-1.2.4-core.js").SetDependencies("Google_jQueryUI").SetVersion("1.2.4");
            manifest.DefineScript("jQueryMootoolsMore").SetUrl("mootools-1.2.4.4-more.js", "mootools-1.2.4.4-more.js").SetDependencies("Google_jQueryUI").SetVersion("1.2.4.4");
            manifest.DefineScript("jQueryFancytree").SetUrl("jquery.fancytree.js", "jquery.fancytree").SetDependencies("Google_jQueryUI").SetVersion("1.0.0");

            // jQuery Charts - HighCharts
            manifest.DefineScript("Highcharts").SetUrl("//code.highcharts.com/highcharts.js", "//code.highcharts.com/highcharts.js").SetDependencies("Google_jQueryUI");
            manifest.DefineScript("HighchartsExporting").SetUrl("//code.highcharts.com/modules/exporting.js", "//code.highcharts.com/modules/exporting.js").SetDependencies("Google_jQueryUI");
